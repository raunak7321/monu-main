...
const MissionVisionValues = () => {
  ...
  return (
    <section className="container w-screen mx-auto px-6 py-10 bg-[#F7EAD0]">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 md:space-x-8">
        {sections.map((section, index) => (
          <div
            key={index}
            className="w-full md:w-1/3 bg-white p-5 shadow-lg rounded-lg hover:shadow-2xl transform transition-all duration-500"
            data-aos="fade-up"
          >
            <div
